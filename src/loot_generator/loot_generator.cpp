...
[[nodiscard]] loot_gen::LootGenerator::TimeInterval LootGenerator::GetTimeInterval() const noexcept {
    return base_interval_;
}

[[nodiscard]] double LootGenerator::GetProbability() const noexcept {
    return probability_;
}
